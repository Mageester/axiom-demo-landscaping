  ...
  <header className="sticky top-0 z-50 w-full bg-blue-700 backdrop-blur-md border-b border-blue-800 shadow-md">
    <div className="max-w-6xl mx-auto px-4 h-20 flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-white font-bold text-xl tracking-tight leading-none uppercase">Apex Landscaping</h1>
...
const Hero: React.FC = () => (
  <section className="relative pt-24 pb-32 px-4 shadow-sm overflow-hidden bg-slate-50">
    <div className="absolute inset-0 z-0">
      <img src="https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?auto=format&fit=crop&w=1200&q=80" alt="LANDSCAPING Professionals" className="w-full h-full object-cover origin-center" />
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
      <div>
        <div className="inline-flex items-center gap-2 bg-blue-800/80 border border-blue-400/30 text-white px-4 py-1.5 rounded-full text-sm font-semibold tracking-wide mb-6">
          ...
          Top Rated Local LANDSCAPING Experts
        </div>
        <h2 className="text-5xl sm:text-6xl font-extrabold text-white mb-6 leading-[1.1] tracking-tight drop-shadow-lg">
          Premium Landscaping & Hardscaping Services. <br /><span className="text-blue-200">24/7 Emergency Repair.</span>
        </h2>
        <p className="text-xl text-blue-50 mb-10 max-w-lg leading-relaxed drop-shadow">
          We install, repair, and maintain residential and commercial LANDSCAPING systems across Ontario. Fast, reliable service when you need it most.
        </p>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { title: 'Commercial Maintenance', desc: 'Routine tune-ups and large-scale commercial LANDSCAPING maintenance plans.' }
              ].map((service, i) => (
      ...
      <footer className="py-12 px-4 border-t border-slate-200 bg-white text-center">
        <div className="max-w-6xl mx-auto flex flex-col items-center">
          <h5 className="text-blue-900 font-bold uppercase tracking-widest mb-4">Apex Landscaping Heroes</h5>
          <p className="text-slate-600 text-sm mb-6">LIC# 8492021 | 100% Satisfaction Guaranteed</p>
          <div className="text-xs font-semibold text-slate-400 uppercase tracking-widest">© {new Date().getFullYear()} Apex Landscaping. All Rights Reserved.</div>
        </div>
      </footer>
    </div>
  );

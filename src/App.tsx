...
const Hero: React.FC = () => (
  <section className="relative pt-24 pb-32 px-4 shadow-sm overflow-hidden bg-slate-50">
    <div className="absolute inset-0 z-0">
      <img src="https://images.unsplash.com/photo-1558904541-efa843a96f0f?auto=format&fit=crop&w=1200&q=80" alt="Landscaping Professionals" className="w-full h-full object-cover origin-center" />
